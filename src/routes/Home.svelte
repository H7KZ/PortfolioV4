<div class="w-full min-h-screen h-full flex justify-center items-center">
	<div class="flex flex-col justify-center">
		<h2 class="font-inter text-2xl text-dark">Hi, my name is</h2>
		<h1 class="relative pt-4 flex flex-col justify-center items-center">
			<img src="images/name.svg" alt="Jan Komínek" class="h-[219px]" />
			<p class="absolute bottom-0 font-inter text-4xl tracking-wider text-main">
				Fullstack Engineer
			</p>
		</h1>
		<div class="pt-16 flex gap-20 justify-center">
			<a
